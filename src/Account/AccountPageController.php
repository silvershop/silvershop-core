...
class AccountPageController extends PageController
{
    ...
    public function init()
    {
        ...
        if (!$this->member) {
            $messages = array(
                'default'    => _t(
                    'SilverShop\Core\Account\AccountPage.Login',
                ...
                'logInAgain' => _t(
                    'SilverShop\Core\Account\AccountPage.LoginAgain',
    ...
    public function getTitle()
    {
        ...
        return _t('SilverShop\Core\Account\AccountPage.DefaultTitle', 'Account');
    }
