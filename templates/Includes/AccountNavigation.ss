<div class="accountnav">
	<div class="nav">
		...
		<ul class="nav nav-list">
			<li><a href="$Link"><i class="icon icon-list"></i> Past Orders</a></li>
			<li><a href="$Link(editprofile)"><i class="icon icon-user"></i> Edit Profile</a></li>
			<li><a href="$Link(addressbook)"><i class="icon icon-book"></i> Address Book</a></li>
