<div class="silvershop-productItem">
    <% if $Image %>
    ...
    <% else %>
        <a href="$Link" title="<%t SilverShop\Generic.ReadMoreTitle "Click here to read more on &quot;{Title}&quot;" Title=$Title %>" class="silvershop-noimage"><!-- no image --></a>
    <% end_if %>
    <h3 class="silvershop-productTitle"><a href="$Link" title="<%t SilverShop\Generic.ReadMoreTitle "Click here to read more on &quot;{Title}&quot;" Title=$Title %>">$Title</a></h3>
    <% if $Model %><p><strong><%t SilverShop\Page\Product.Model "Model" %>:</strong> $Model.XML</p><% end_if %>
    <div>
        <% include SilverShop\Includes\Price %>
        <% if $View %>
            <div class="silvershop-view">
                <a href="$Link" title="<%t SilverShop\Generic.ReadMoreTitle "Click here to read more on &quot;{Title}&quot;" Title=$Title %>">
