...
final class CheckoutComponentTest extends SapphireTest
{
    ...
    public function testSinglePageConfig(): void
    {
        ...
        $this->assertContainsOnlyInstancesOf(
            $class,
            $arrayList,
            sprintf("Components must only be of type '%s'", $class)
        );
        ...
        $this->assertStringContainsString(
            ...
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-CustomerDetails_FirstName field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-CustomerDetails_Surname',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-CustomerDetails_Surname field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-CustomerDetails_Email',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-CustomerDetails_Email field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-ShippingAddress_Country',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-ShippingAddress_Country field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-ShippingAddress_Address',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-ShippingAddress_Address field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-ShippingAddress_City',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-ShippingAddress_City field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-ShippingAddress_State',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-ShippingAddress_State field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-BillingAddress_Country',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-BillingAddress_Country field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-BillingAddress_Address',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-BillingAddress_Address field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-BillingAddress_City',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-BillingAddress_City field', $ns)
        );
        $this->assertStringContainsString(
            $ns . '-BillingAddress_State',
            print_r($fields, true),
            sprintf('Form Fields should contain a %s-BillingAddress_State field', $ns)
        );
